...
.forEach returns undefined, it calls a certain function on each element in an array
.map uses return values and returns a new array

2. What is the difference between a function and a method?

A function returns a value.
A method is internal to a class, and uses the "this" keyword.

3. What is closure?

Gives access to an outer functions scope from an inner function. Closures are created when a function is created.
...
Pulls data from the class it's extending from.
